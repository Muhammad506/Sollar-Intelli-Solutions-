  ...
  return (
    <main className="relative">
      ...
      >
        ...
        <div className="grid grid-cols-2 text-white sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 px-2 mr-2 md:px-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group flex flex-col items-center justify-center p-2 border border-transparent rounded-lg bg-gradient-to-r from-[#021430] via-[#0f1c47] to-[#021430] shadow-lg lg:hover:shadow-2xl transition-transform duration-300 lg:hover:-translate-y-2 lg:hover:scale-105"
